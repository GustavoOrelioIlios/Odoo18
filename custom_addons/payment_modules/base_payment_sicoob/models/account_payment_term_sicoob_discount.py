...
class AccountPaymentTermSicoobDiscount(models.Model):
    ...
    days = fields.Integer(
        ...
        help="Prazo limite para o desconto, em dias após a data da fatura.\n"
             ...
             "⚠️ API Sicoob exige ordem decrescente (maior → menor)."
    )
    ...
    value = fields.Float(
        ...
        help="Valor do desconto conforme tipo selecionado no termo:\n\n"
             "📊 Para tipos Percentual (2, 5, 6): Digite o percentual\n"
             "   • Exemplo: 5.0 = 5% de desconto\n\n"
             "💰 Para tipos Valor Fixo (1, 3, 4): Digite o valor em reais\n"
    ...
    @api.depends('payment_term_id.sicoob_discount_code')
    ...
    @api.depends('days', 'value', 'payment_term_id.sicoob_discount_code')
